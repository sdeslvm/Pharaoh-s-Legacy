...
protocol WebLoadable: AnyObject {
    var state: PharaohsWebStatus { get set }
...
final class PharaohsWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: PharaohsWebStatus = .standby
...
extension PharaohsWebLoader: WKNavigationDelegate {
