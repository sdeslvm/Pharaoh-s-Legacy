...
struct PharaohsWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: PharaohsWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> PharaohsWebCoordinator {
        PharaohsWebCoordinator { [weak loader] status in
