...
enum PharaohsWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: PharaohsWebStatus) -> Bool {
        switch (self, other) {
...
extension PharaohsWebStatus {
    static func == (lhs: PharaohsWebStatus, rhs: PharaohsWebStatus) -> Bool {
